  ...
  <div class="loggedin">
    ...
    <el-dropdown class="name" @command="quits">
      <span class="el-dropdown-link">
        ...
        }}<span v-if="getUserStatus == 1" class="to-be-reviewed">(待审核)</span
    ...
    <!-- 用户积分 -->
    <div class="fraction">分数:{{ fraction }}</div>
...
export default {
  ...
  methods: {
    ...
    async viewStatus() {
      ...
      let { data } = await this.$http.post(`/getUser`, obj)
      // console.log(data.data)
      this.getUserName.username = data.data.username
      this.getUserStatus = data.data.status
      // return data
    },
    //定时请求 查看状态
    regularView() {
