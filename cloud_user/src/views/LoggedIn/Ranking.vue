        ...
        <div class="cont" ref="mapRef">
          <div class="rk">
            ...
            >
              ...
              <el-table-column prop="count" label="完成题目数">
              </el-table-column>
          ...
          <div class="score">
            ...
            >
              ...
              <el-table-column prop="score" label="加分"> </el-table-column>
...
export default {
  ...
  created() {
    ...
    this.usernameId = sessionStorage.getItem('user_id')
  ...
  methods: {
    ...
    async getUserFractionFn() {
      let obj = {
        // ...this.parameter,
        user_id: parseInt(this.usernameId),
      }
      let { data } = await this.$http.post('/userThing', obj)
      this.getUserFractionList = data.data
    },
    // 获取得分事件
    ...
    async RankingListFn() {
      ...
      let { data } = await this.$http.post('/rankingList', obj) // ,obj)
      this.RankingListData = data.data
    },
    // 轮播
    mapf() {
