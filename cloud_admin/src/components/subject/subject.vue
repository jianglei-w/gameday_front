      ...
      <el-card class="card">
        ...
        >
          ...
          <el-form-item label="题目答案:" prop="answer">
            <el-input
              v-model="upload.answer"
              placeholder="请输入题目答案"
            ></el-input>
          </el-form-item>
          <el-form-item label="题目分数:" prop="grade">
            <el-input
              v-model.number="upload.grade"
              autocomplete="on"
              placeholder="请输入题目分数"
            ></el-input>
          </el-form-item>
          ...
          <el-form-item>
            <el-button class="empty" @click="empty"> 清空内容 </el-button>
            <el-button class="define" @click="uploadSubject"> 上传 </el-button>
          </el-form-item>
        </el-form>
      </el-card>
      <!--弹出md输入框 -->
  ...
  methods: {
    ...
    uploadSubject() {
      this.$refs.uploadRef.validate(async valid => {
        ...
        // this.upload.grade = parseInt(this.upload.grade, 10)
